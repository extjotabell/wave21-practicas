...
class UserServiceTest {
    ...
    void followUserTestUserToFollowDoesntExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.followUser(user.getId(), nonExistentUserId));
    }
    ...
    void followUserTestUserToFollowAlreadyBeingFollowed() {
        ...
        UserFollowingException userFollowingException =
                assertThrows(UserFollowingException.class, () -> _userService.followUser(user.getId(), userToFollow.getId()));
    ...
    void followUserTestUserToFollowIsNotASeller() {
        ...
        //Act & Assert
        assertThrows(UserNotSellerException.class, () -> _userService.followUser(user.getId(), userToFollow.getId()));
    }
    ...
    void followUserTestUserToFollowMyself() {
        ...
        //Act & Assert
        UserFollowingException userFollowingException =
                assertThrows(UserFollowingException.class, () -> _userService.followUser(userToFollow.getId(), userToFollow.getId()));
    ...
    void followUserTestUserWhoFollowsNotExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.followUser(nonExistentUserId, userToFollow.getId()));
    }
    ...
    void unfollowUserTestUserToUnFollowDoesntExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.unFollowUser(user.getId(), nonExistentUserId));
    }
    ...
    void unfollowUserTestUserToUnFollowNotBeingFollowed() {
        ...
        //Assert
        UserFollowingException userFollowingException =
                assertThrows(UserFollowingException.class, () -> _userService.unFollowUser(user.getId(), userToFollow.getId()));
    ...
    void unfollowUserTestUserToUnFollowIsNotASeller() {
        ...
        //Act & Assert
        assertThrows(UserNotSellerException.class, () -> _userService.unFollowUser(user.getId(), userToFollow.getId()));
    }
    ...
    void unfollowUserTestUserWhoUnFollowsNotExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.unFollowUser(nonExistentUserId, userToFollow.getId()));
    }
    ...
    void getFollowersCountTestUserIsNotSeller() {
        ...
        //Act & Assert
        assertThrows(UserNotSellerException.class, () -> _userService.getFollowersCount(user.getId()));
    }
    ...
    void getFollowersCountTestUserDoesntExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.getFollowersCount(nonExistentUserId));
    }
    ...
    void getFollowersListOrderTestUserDoesntExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.getFollowersList(nonExistentUserId, Constants.ORDER_NAME_ASC));
    }
    ...
    void getFollowersListOrderTestOrderDoesntExists() {
        ...
        //Act & Assert
        assertThrows(OrderNotFoundException.class, () -> _userService.getFollowersList(user.getId(), "wrong_order"));
    }
    ...
    void getFollowedListOrderTestUserDoesntExists() {
        ...
        //Act & Assert
        assertThrows(UserNotFoundException.class, () -> _userService.getFollowedList(nonExistentUserId, Constants.ORDER_NAME_ASC));
    }
    ...
    void getFollowedListOrderTestOrderDoesntExists() {
        ...
        //Act & Assert
        assertThrows(OrderNotFoundException.class, () -> _userService.getFollowedList(user.getId(), "wrong_order"));
    }
