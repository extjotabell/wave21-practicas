...
public class CalculateRestControllerTestInt {

    @Autowired
    private MockMvc mockMvc;

    // Se pide, retornar un objeto que diga la cantidad total de metros cuadrados de la casa.
    @Test
    ...
    // Se pide, retornar un objeto que diga la cantidad total de metros cuadrados de multiples casas.
    @Test
    ...
    // Retornar el objecto con la habitacion mas grande.
    @Test
