...
public class UserServiceImp implements IUserService{
    ...
    public UserDto buscarUnUsuarioPorNombre(String name) {
        ...
        //Optional<User> usuarioRepo2 = userRepository.buscarUsuarioPorNombre(name).orElseThrow();
    ...
    @Override
    public int calculeTotal(int a, int b){
        return a + b;
    }

    @Override
    public int calcularNumeroMenor(int a , int b){
        if(a < b){
            return a;
        }else{
            return b;
