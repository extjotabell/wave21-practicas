...
public class FindControllerTests {
    ...
    public void findAll2() throws Exception{
        CharacterDTO character = new CharacterDTO("Darth Vader", "none", "white", "yellow",
                "419BBY", "male", "Tatooine", "Human", 202, 136);
        CharacterDTO character2 = new CharacterDTO("Darth Maul", "none", "red", "yellow",
                        "54BBY", "male", "Dathomir", "Zabrak", 175, 80);
        List<CharacterDTO> characters = new ArrayList<>();
        characters.add(character);
        characters.add(character2);

        String expected = writer.writeValueAsString(characters);
