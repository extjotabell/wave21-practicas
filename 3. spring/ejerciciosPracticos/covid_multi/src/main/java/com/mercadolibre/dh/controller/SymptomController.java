...
public class SymptomController {
    ...
    //@Autowired cumple la misma función que instanciar el servicio en el constructor
    SymptomService service;

    // Inyección de independencia, dejamos que springboot se encarga de generar el servicio
    // dejar que el framework se encargue de esto se llama inversión de control
