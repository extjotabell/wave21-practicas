public class EjercicioCiudades {
    public static void main(String[] args) {
        ...
        int menorTemperatura = temperatura[0][0]; // Inicializamos la menor temperatura con el primer valor de Londres
        String ciudadMenorTemperatura = ciudades[0]; // Inicializamos la ciudad de la menor temperatura con la primera ciudad

        int mayorTemperatura = temperatura[0][0]; // Inicializamos la mayor temperatura con el primer valor de Londres
        String ciudadMayorTemperatura = ciudades[0]; // Inicializamos la ciudad de la mayor temperatura con la primera ciudad
