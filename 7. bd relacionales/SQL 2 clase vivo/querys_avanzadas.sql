...
CREATE TABLE departamento(
	depto_nro VARCHAR(30) PRIMARY KEY NOT NULL,
    nombre_depto VARCHAR(30),
    localidad VARCHAR(30)
);

CREATE TABLE empleado (
	cod_emp VARCHAR(30) PRIMARY KEY NOT NULL,
    nombre VARCHAR(30),
    apellido VARCHAR(30),
    puesto VARCHAR(30),
    fecha_alta DATE,
...
AND e.salario = (SELECT MAX(salario) FROM empleado WHERE depto_nro = e.depto_nro);
