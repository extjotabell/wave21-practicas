...
Select title as Titulo from series; -- TERMINAR
...
select title from movies where rating > 3 and awards >3 and release_date between '1998-01-01' and '2009-12-31' order by rating
