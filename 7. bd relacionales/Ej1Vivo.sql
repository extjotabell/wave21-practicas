...
select title from movies m where m.release_date between '2004-01-01' and '2008-12-12'; 

-- Traer el título de las películas con el rating mayor a 3, con más de 1 premio y con fecha de lanzamiento entre el año 1988 al 2009. Ordenar los resultados por rating.
select title from movies m where rating>3 and awards>1 and release_date between '1988-01-01' and '2009-12-12' order by rating;