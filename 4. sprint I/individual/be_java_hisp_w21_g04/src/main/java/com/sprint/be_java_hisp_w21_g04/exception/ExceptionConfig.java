...
public class ExceptionConfig {
    ...
    @ExceptionHandler(EmptySellerFollowedListException.class)
    ...
    @ExceptionHandler(NotFoundProductsPromoException.class)
    public ResponseEntity<?> notFoundProductsPromoException(Exception e){
        ErrorDto error = new ErrorDto(e.getMessage(), 400);
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
