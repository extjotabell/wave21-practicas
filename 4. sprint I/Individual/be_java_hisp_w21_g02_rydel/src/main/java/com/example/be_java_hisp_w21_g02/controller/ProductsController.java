...
public class ProductsController {
    ...
    public ResponseEntity<?> createPromoPost(@RequestBody PromoPostRequestDTO promoPostRequestDTO){
        return productsService.createPromoPost(promoPostRequestDTO);
    }
    ...
    public ResponseEntity<?> promoPostCountBySeller(@RequestParam("user_id") int userId){
        return productsService.promoPostCountBySeller(userId);
    }
