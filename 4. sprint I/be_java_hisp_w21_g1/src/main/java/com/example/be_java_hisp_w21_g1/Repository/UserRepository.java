...
public class UserRepository implements IUserRepository {
    ...
    private void init() {
        ...
        Post post1 = new Post(1, 1, LocalDate.of(2023, 06, 04), product1, 1, 25.50, false, 0);
        Post post2 = new Post(1, 2, LocalDate.of(2023, 05, 28), product2, 1, 15.90, false, 0);
        Post post3 = new Post(1, 3, LocalDate.of(2022, 04, 04), product3, 1, 190.00, false, 0);
        Post post4 = new Post(1, 4, LocalDate.of(2023, 05, 29), product2, 1, 90.90, false, 0);
        ...
        ArrayList<User> followed2 = new ArrayList<>();
        followed2.add(user1);
