...
public class Controller {
    ...
    public ResponseEntity<?> newProductInSale(@RequestBody PostProductPromoDTO postProductPromoDTO) {
        userService.createPostWithPromo(postProductPromoDTO);
    ...
    public ResponseEntity<PromoPostCountDTO> promoProductsCount(@RequestParam(value = "user_id", required = true) int userId) {
        return ResponseEntity.ok(userService.listPostsWithPromoBySeller(userId));
    }
