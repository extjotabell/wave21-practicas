...
public class UserRepository implements IUserRepository {
    ...
    private void init() {
        ...
        Post post1 = new Post(1, 1, LocalDate.of(2023, 06, 04), product1, 1, 25.50, false, null);
        Post post2 = new Post(1, 2, LocalDate.of(2023, 05, 28), product2, 1, 15.90,false, null);
        Post post3 = new Post(1, 3, LocalDate.of(2022, 04, 04), product3, 1, 190.00,false, null);
        Post post4 = new Post(1, 4, LocalDate.of(2023, 05, 29), product2, 1, 90.90,false, null);
    ...
    @Override
    public void savePostInSale(Post newPost) {
        for (User user: users){
            if(user.getUser_id() == newPost.getUserId()){
                List<Post> postList = user.getPosts();
                Optional<Post> p = postList.stream().filter(pr -> pr.getPostId() == newPost.getPostId()).findFirst();
